...
AimingLine.prototype = {
	init: function () {
		...
		this.line0 = this.game.add.sprite(0,0,'PIC_ALL_ART',"BasicAimingLine0000",this.content);
		this.line1 = this.game.add.sprite(0,0,'PIC_ALL_ART',"BasicAimingLine0000",this.content);
		this.line0.anchor.setTo(0.5, 1);
		this.line1.anchor.setTo(0.5, 1);
		
		this.deltaText = this.game.add.text(0,0,"Text",{font:"16px Arial", align:"center"},this.content);
		this.deltaText.anchor.setTo(0.5, 1);
	...
	onLine1Complete: function ()
	{
		...
		this.txtTwn = this.game.add.tween(this.deltaText);
		this.txtTwn.to({y:this.deltaText.y+10, alpha:1},300);
