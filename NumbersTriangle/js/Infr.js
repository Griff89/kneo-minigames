...
*/
		//temporary strings to showScore the informer data - removeAttribute them after reskinning
		//this.capTxt=this.game.add.text(0,-30, '', {align:"middle", font:"14px Arial"});
		//this.content.add(this.capTxt);
		
		if (useBig){
			this.scrTxt=this.game.add.bitmapText (0, 0, 'PIC_FONT_BLUE3', '000', 36);
			} else{
				this.scrTxt=this.game.add.bitmapText (0, 0, 'PIC_FONT_BLUE2', '000', 24);
	...
	//    this.game.load.spritesheet('dude', 'assets/dude.png', 32, 48);
			...
			//this.capTxt.text = str; //temporary string
			this.showScore(0);	
