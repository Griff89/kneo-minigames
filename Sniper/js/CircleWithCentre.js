...
CircleWithCentre.prototype = {
	init: function () {
        ...
        this.base = this.game.add.sprite(0,0,'CIRCLES');
        this.content.add(this.base);
		...
		this.resPercent = this.game.add.text(0,0,'%',{font:"24px Arial", fill:"#002222", align:"center"},this.content);
