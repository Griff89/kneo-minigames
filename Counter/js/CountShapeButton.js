...
CountShapeButton.prototype = {
	init: function () {
		...
		*/
        this.msk = this.game.add.sprite(0,0);
        this.msk.owner = this;
        this.msk.width = 100;
        this.msk.height = 100;
        this.content.add(this.msk);

        this.txt=this.game.add.bitmapText (73, 52, 'red', '0', 36);
        this.txt.align = 'center';
        this.txt.pivot.x = (this.txt.textWidth / 2);
        this.txt.pivot.y = (this.txt.textHeight / 2);
	...
	awake: function (num, willBCorr) {
        ...
        setTimeout(function(){
            this.content.x = this.content.orgX - this.txt.textWidth / 2;
        }.bind(this), 20);
